class Animal {
    ...
    move(terrain) {
        ...
        if (y_min < 0) y_min = 0;
        else if (y_max) y_max = terrainColCount - 1;
        ...
        if(this.thirst < this.hunger) {
            ...
            if(!closestWaterSquare) {
                // No water in range, move to random square
            ...
            else if(closestWaterSquare.dist == 1) {
